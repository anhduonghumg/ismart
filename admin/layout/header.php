            ...
            <div id="header-wp">
                <div class="wp-inner clearfix">
                    ...
                    <ul id="main-menu" class="fl-left">
                        <li>
                            <a href="?mod=post&action=list_post" title="">Trang</a>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="?mod=post&controller=cat&action=list_cat" title="">Danh mục bài viết</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="?mod=product&controller=cat&action=list_cat" title="">Danh mục sản phẩm</a>
                                </li>
                                <li>
                                    <a href="?mod=product&controller=brand" title="">Danh sách thương hiệu</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="?mod=order&action=list_order" title="">Bán hàng</a>
                            <ul class="sub-menu">
                                <li>
                    ...
                    <div id="dropdown-user" class="dropdown dropdown-extended fl-right">
                        <button class="dropdown-toggle clearfix" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            ...
                            <h3 id="account" class="fl-right"><?php echo info_user("fullname"); ?></h3>
                        </button>
