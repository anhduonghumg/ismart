    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách sản phẩm chờ duyệt</h3>
                    ...
                    <div class="section-detail">
                        <div class="filter-wp clearfix">
                            <ul class="post-status fl-left">
                                ...
                                <li class="publish"><a href="?mod=product&action=published">Đã đăng <span class="count">(<?php echo get_num_post('tbl_products', "product_status='2'"); ?>)</span></a> |</li>
                                <li class="pending"><a href="?mod=product&action=pending">Chờ xét duyệt <span class="count">(<?php echo get_num_waiting('tbl_products', "product_status='1'"); ?>)</span></a></li>
                                <li class="trash"><a href="?mod=product&action=trash">Thùng rác <span class="count">(<?php echo get_num_trash('tbl_products', "product_status='3'"); ?>)</span></a></li>
                            </ul>
            ...
            <?php } else { ?>
                <p>Không có bài viết nào.Bấm vào đây để <a href="?mod=product&action=list_product">quay lại</a></p>
            <?php } ?>
        </div>
    </div>
</div>
