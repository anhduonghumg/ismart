        ...
        <div id="content" class="fl-right">
            ...
            ?>
                <div class="section" id="detail-page">
                    <a href="?mod=product&action=list_product">Trở về trang chính</a>
                ...
                <?php } else {
                ?>
                    <p>Không tìm thấy kết quả nào.Click vào đây để quay lại <a href="?mod=product&action=list_product">Quay lại.</a></p>
                <?php } ?>
                </div>

                <div class="section" id="paging-wp">
                    <div class="section-detail clearfix">
                        <?php echo get_pagging($num_page, $page, "?mod=product&action=search&s={$key}&sm_s=Tìm+kiếm"); ?>
                    </div>
                </div>
        </div>
    </div>
