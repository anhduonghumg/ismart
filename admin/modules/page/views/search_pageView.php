...
<div id="main-content-wp" class="list-post-page">
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            ...
            <?php
            global $list_search, $key, $num_row, $num_per_page, $page, $start, $num_page;
            if (!empty($list_search)) {
            ?>
                <div class="section" id="detail-page">
                    <a href="?mod=page&action=index">Trở về trang chính</a>
                ...
                <?php } else {
                ?>
                    <p>Không tìm thấy kết quả nào.Click vào đây để quay lại <a href="?mod=page&action=index">Quay lại.</a></p>
                <?php } ?>
                </div>
