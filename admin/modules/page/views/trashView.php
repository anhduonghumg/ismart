        ...
        <div id="content" class="fl-right">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="tbody-text" href="<?php echo $item['url_restore']; ?>">Khôi phục</a>|<a class="tbody-text" href="<?php echo $item['url_delete']; ?>">Xóa</a></td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <?php echo get_pagging($num_page, $page, "?mod=page&action=trash"); ?>
                </div>
            </div>
        </div>
    </div>
