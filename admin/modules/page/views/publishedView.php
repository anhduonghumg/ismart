        ...
        <div id="content" class="fl-right">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="tbody-text"><?php echo $item['approved']; ?></span></td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <?php echo get_pagging($num_page, $page, "?mod=page&action=published"); ?>
                </div>
            </div>
        </div>
    </div>
