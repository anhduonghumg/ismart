            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST">
                        ...
                        <input type="text" name="title" id="title" value="<?php echo $list_post_cat_by_id['post_cat_title'] ?>">
                        <?php echo form_error('title'); ?>
                        <label for="title">Slug ( Friendly_url )</label>
                        <input type="text" name="slug" id="slug" value="<?php echo $list_post_cat_by_id['slug'] ?>">
